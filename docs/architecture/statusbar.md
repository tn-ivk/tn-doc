...
|----------|----------|----------|----------------------|
| `InitialPollSeconds` | Начальный интервал опроса | 1–3600 сек | 60 сек |
| `MaxPollSeconds` | Максимальный интервал опроса | 60–86400 сек | 3600 сек |
| `PollMultiplier` | Множитель увеличения интервала (шаг 0.1) | 1.1–10 | 2.0 |
| `NetworkFailureThreshold` | Порог для учёта отказа сети | 1–100 | 3 |
| `MaxRetryCount` | Макс. попыток до перехода в HalfOpen | 1–1000 | 24 |
