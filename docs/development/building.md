...
| **document-editor** | In Development | 5174 | Редактор паспортов качества с ELIS и OPC интеграцией |
...
- `wwwroot/{statusbar,configurator,document-editor}/` (генерируется автоматически)
