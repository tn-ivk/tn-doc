...
- При сохранении паспорта качества slave-параметры автоматически получают флаг `Legal = 0`
- Это означает, что slave-параметры не участвуют в легализации документа
- Только master-параметр учитывается при валидации заполненности данных
