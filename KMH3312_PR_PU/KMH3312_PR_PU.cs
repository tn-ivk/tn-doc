...
namespace TN.Doc
{
    public class KMH3312_PR_PU : DocGeneral
    {
        public KMH3312_PR_PU(DbContextOptions<DocGeneral> options, string path, Device device) : base(options, path, device)
        {
        ...
        private DbSet<TableKMH3312_PR_PUList> ListDoc { get; set; }
        private DbSet<TableKMH3312_PR_PUData> DataDoc { get; set; }
        ...
        public override List<RequestListDocs> GetList(long UTBegin, long UTEnd)
        {
            ...
            var list = (from item in ListDoc.AsNoTracking()
                        ...
                        select item).ToList<TableKMH3312_PR_PUList>();
        ...
        public override object GetViewDoc(int id)
        {
            ...
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_PR_PU.id = list.id;
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_PR_PU.IL = list.IL;
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_PR_PU.UPR_LineIndx = list.UPR_LineIndx;
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_PR_PU.Protokol = JsonDeserializeObject<Protokol>(ArrByteToString(list.Data.Protokol));
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo = JsonDeserializeObject<AdditionalInfo>(ArrByteToString(list.Data.AdditionalInfo));
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_PR_PU.DateTimeString = list.DateTimeString;
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_PR_PU.DateTimeLong = list.DateTimeLong;
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_PR_PU.BIK_ID = list.BIK_ID;
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_PR_PU.IL_Name = ArrByteToString(list.IL_Name);
        ...
        public override string GetEditDoc(int id)
        {
            ...
            foreach (var item in editDoc.AdditionalInfo.Where(x => x.Use).ToList())
            {
                ...
                if (item.Key == "Place_PSP")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.Place_PSP;
                else if (item.Key == "Place_SIKN")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.Place_SIKN;
                else if (item.Key == "Place_Factory")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.Place_Factory;
                else if (item.Key == "PR_Type")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.PR_Type;
                else if (item.Key == "PR_FactoryNumber")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.PR_FactoryNumber;
                else if (item.Key == "PR_LineName")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.PR_LineName;
                else if (item.Key == "MM_Sensor_Type")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.MM_Sensor_Type;
                else if (item.Key == "MM_Sensor_DU")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.MM_Sensor_DU;
                else if (item.Key == "MM_Sensor_FactoryNumber")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.MM_Sensor_FactoryNumber;
                else if (item.Key == "MM_PEP")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.MM_PEP;
                else if (item.Key == "MM_PEP_FactoryNumber")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.MM_PEP_FactoryNumber;
                else if (item.Key == "PU_Type")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.PU_Type;
                else if (item.Key == "PU_FactoryNumber")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.PU_FactoryNumber;
                else if (item.Key == "PP_Type")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.PP_Type;
                else if (item.Key == "PP_FactoryNumber")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.PP_FactoryNumber;
                else if (item.Key == "IVK_Type")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.IVK_Type;
                else if (item.Key == "IVK_FactoryNumber")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.IVK_FactoryNumber;
                else if (item.Key == "Oil_Type")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.Oil_Type;
                else if (item.Key == "ProtokolNum")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.ProtokolNum;
                else if (item.Key == "StaffData")
                    currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo.StaffData;
        ...
        public override bool SaveDoc(string jsonData)
        {
            ...
            TableKMH3312_PR_PUData row = new();
            GetViewDoc(data.DocID);

            ad = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_PR_PU.AdditionalInfo;
    ...
    [Table("TableKMH3312_PR_PU")]
    public class TableKMH3312_PR_PUList
    {
        [Key, ForeignKey("Data")]
        ...
        public TableKMH3312_PR_PUData Data { get; set; }
    }

    [Table("TableKMH3312_PR_PU")]
    public class TableKMH3312_PR_PUData
    {
        [Key]
        public int id { get; set; }
    ...
    public class Doc : Root
    {
        public Doc()
        {
            ...
            ((DataIVKDoc)Doc.DataIVK).TableKMH3312_PR_PU = new TableKMH3312_PR_PU();
        }
    }
    ...
    {
        public TableKMH3312_PR_PU TableKMH3312_PR_PU { get; set; }
    }
    public class TableKMH3312_PR_PU
    {
        public int id { get; set; }
        public int IL { get; set; }
        public int UPR_LineIndx { get; set; }
