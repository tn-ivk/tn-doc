...
namespace TN.Doc
{
    public class Poverka1974 : DocGeneral
    {
        public Poverka1974(DbContextOptions<DocGeneral> options, string path, Device device) : base(options, path, device)
        {
            IdDoc = IdDoc.Poverka1974;
        ...
        private DbSet<TablePoverka1974List> ListDoc { get; set; }
        private DbSet<TablePoverka1974Data> DataDoc { get; set; }
        ...
        public override List<RequestListDocs> GetList(long UTBegin, long UTEnd)
        {
            ...
            var list = (from item in ListDoc.AsNoTracking()
                        ...
                        select item).ToList<TablePoverka1974List>();
        ...
        public override object GetViewDoc(int id)
        {
            ...
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka1974.id = list.id;
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka1974.IL = list.IL;
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka1974.Protokol = JsonDeserializeObject<Protokol>(ArrByteToString(list.Data.Protokol));
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo = JsonDeserializeObject<AdditionalInfo>(ArrByteToString(list.Data.AdditionalInfo));
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka1974.DateTimeString = list.DateTimeString;
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka1974.DateTimeLong = list.DateTimeLong;
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka1974.BIK_ID = list.BIK_ID;
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka1974.IL_Name = ArrByteToString(list.IL_Name);
            ...
            foreach (var item in editDoc.AdditionalInfo.Where(x => x.Use).ToList())
            {
                ...
                if (item.Type == "list")
                {
                    ...
                    if (item.Key == "ARM_Poverka_Result")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo.ARM_Poverka_Result;
                ...
                else
                {
                    ...
                    if (item.Key == "Place_SIKN")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo.Place_SIKN;
                    else if (item.Key == "Place_PSP")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo.Place_PSP;
                    else if (item.Key == "Place_Factory")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo.Place_Factory;
                    else if (item.Key == "PR_Type")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo.PR_Type;
                    else if (item.Key == "PR_FactoryNumber")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo.PR_FactoryNumber;
                    else if (item.Key == "PR_LineName")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo.PR_LineName;
                    else if (item.Key == "PU_Type")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo.PU_Type;
                    else if (item.Key == "PU_Category")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo.PU_Category;
                    else if (item.Key == "PU_FactoryNumber")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo.PU_FactoryNumber;
                    else if (item.Key == "OilType")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo.OilType;
                    else if (item.Key == "ProtokolNum")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo.ProtokolNum;
                    else if (item.Key == "ARM_Poverka_Result")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo.ARM_Poverka_Result;
                    else if (item.Key == "StaffData")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo.StaffData;
        ...
        public override bool SaveDoc(string jsonData)
        {
            ...
            TablePoverka1974Data row = new();
            GetViewDoc(data.DocID);

            ad = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka1974.AdditionalInfo;
    ...
    [Table("TablePoverka1974")]
    public class TablePoverka1974List
    {
        [Key, ForeignKey("Data")]
        ...
        public TablePoverka1974Data Data { get; set; }
    }

    [Table("TablePoverka1974")]
    public class TablePoverka1974Data
    {
        [Key]
        public int id { get; set; }
    ...
    public class Doc : Root
    {
        public Doc()
        {
            ...
            ((DataIVKDoc)Doc.DataIVK).TablePoverka1974 = new TablePoverka1974();
        }
    }
    ...
    {
        public TablePoverka1974 TablePoverka1974 { get; set; }
    }

    public class TablePoverka1974
    {
        public int id { get; set; }
        public int IL { get; set; }
    ...
    public class Protokol
    {
        ...
        public string ViscMin { get; set; }
        public string ViscMax { get; set; }
    ...
    public class Table1
    {
        ...
        public List<string> Teta_Sum0 { get; set; }
        public List<string> Teta_V0 { get; set; }
        public string Delta_t_PU { get; set; }
        public string t_kernel { get; set; }
    ...
    public class Table3
    {
        ...
        public string Teta_Sum_j { get; set; }
    ...
    public class Table5
    {
        ...
        public string Q_max { get; set; }
        public string e { get; set; }
        public string Theta_A { get; set; }
        public string Theta_Sum { get; set; }
        public string Delta { get; set; }
        public string Delta_ERROR { get; set; }
        public string K { get; set; }
    }
