...
1. Фаза 0: 4-6 дней (включая подготовку livedb-контура для пилота и решение по внедрению MySQL-контура в CI)
...
6. `TDOC-CHAR-303` блокируется `TDOC-CHAR-305` (nightly livedb запускается только после готовности MySQL service container и seed-процедуры в CI).
