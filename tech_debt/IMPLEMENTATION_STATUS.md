...
1. **Интеграция с существующим UI**
   - ⬜ Обновить HomeController для маршрутизации на Vue SPA
   - ⬜ Модифицировать iframe в Index.cshtml для поддержки новых URL
   - ⬜ Добавить переключатель между старым и новым редактором
