...
namespace TN.Doc
{
    public class Poverka3312_PR_PU : DocGeneral
    {
        public Poverka3312_PR_PU(DbContextOptions<DocGeneral> options, string path, Device device) : base(options, path, device)
        {
        ...
        private DbSet<TablePoverka3312_PR_PUList> ListDoc { get; set; }
        private DbSet<TablePoverka3312_PR_PUData> DataDoc { get; set; }
        ...
        public override object GetViewDoc(int id)
        {
            ...
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka3312_PR_PU.AdditionalInfo = JsonDeserializeObject<AdditionalInfo>(ArrByteToString(list.Data.AdditionalInfo));
    ...
    [Table("TablePoverka3312_PR_PU")]
    public class TablePoverka3312_PR_PUList
    {
        [Key, ForeignKey("Data")]
    ...
    [Table("TablePoverka3312_PR_PU")]
    public class TablePoverka3312_PR_PUData
    {
        [Key]
        public int id { get; set; }
