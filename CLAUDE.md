...
- **OPC DA/UA**: теги в `opc.da.tags.json`, данные через `TN_MessagingService` (localhost:5010)
- **MySQL/MariaDB**: Pomelo.EntityFrameworkCore.MySql, multi-channel подключения с автоматическим failover
...
- `tech_debt/` — планы по техническому долгу (17 файлов)
