...
│   └── Client/                # Vue 3 компоненты (опционально)
...
└── Tests/                     # NUnit тесты (4 проекта)
    ...
    ├── Tests.Integration/     # Интеграционные (КМХ, Common)
...
| Tests.Integration | Интеграционные | КМХ (~168 тестов), Common |
| Tests.E2E | End-to-end | Placeholder |
| Tests.Shared | Общие helpers | Fixtures, utilities |

**Статус (v1.3.8):** ~315 работающих (~48%), ~335 отключенных (~52%)
