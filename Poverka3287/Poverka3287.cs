...
namespace TN.Doc
{
    public class Poverka3287 : DocGeneral
    {
        public Poverka3287(DbContextOptions<DocGeneral> options, string path, Device device) : base(options, path, device)
        {
            IdDoc = IdDoc.Poverka3287;
            ...
            foreach (var item in editDoc.AdditionalInfo.Where(x => x.Use).ToList())
            {
                ...
                if (item.Type == "list")
                {
                    ...
                    if (item.Key == "ARM_Poverka_Result")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3287.AdditionalInfo.ARM_Poverka_Result;
                ...
                else
                {
                    ...
                    if (item.Key == "Place")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3287.AdditionalInfo.Place;
                    else if (item.Key == "Place_SIKN")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3287.AdditionalInfo.Place_SIKN;
                    else if (item.Key == "Place_Factory")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3287.AdditionalInfo.Place_Factory;
                    else if (item.Key == "PR_Type")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3287.AdditionalInfo.PR_Type;
                    else if (item.Key == "PR_FactoryNumber")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3287.AdditionalInfo.PR_FactoryNumber;
                    else if (item.Key == "PR_LineName")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3287.AdditionalInfo.PR_LineName;
                    else if (item.Key == "PU_Type")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3287.AdditionalInfo.PU_Type;
                    else if (item.Key == "PU_FactoryNumber")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3287.AdditionalInfo.PU_FactoryNumber;
                    else if (item.Key == "IVK_Type")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3287.AdditionalInfo.IVK_Type;
                    else if (item.Key == "IVK_FactoryNumber")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3287.AdditionalInfo.IVK_FactoryNumber;
                    else if (item.Key == "ProtokolNum")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3287.AdditionalInfo.ProtokolNum;
                    else if (item.Key == "StaffData")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3287.AdditionalInfo.StaffData;
        ...
        public override bool SaveDoc(string jsonData)
        {
            ...
            TablePoverka3287Data row = new();
            GetViewDoc(data.DocID);

            ad = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3287.AdditionalInfo;
