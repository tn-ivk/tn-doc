...
namespace TN.Doc
{
    public class Poverka3265_UPR_PU : DocGeneral
    {
        public Poverka3265_UPR_PU(DbContextOptions<DocGeneral> options, string path, Device device) : base(options, path, device)
        {
            IdDoc = IdDoc.Poverka3265_UPR_PU;
        ...
        private DbSet<TablePoverka3265_UPR_PUList> ListDoc { get; set; }
        private DbSet<TablePoverka3265_UPR_PUData> DataDoc { get; set; }
        ...
        public override List<RequestListDocs> GetList(long UTBegin, long UTEnd)
        {
            ...
            var list = (from item in ListDoc.AsNoTracking()
                        ...
                        select item).ToList<TablePoverka3265_UPR_PUList>();
        ...
        public override object GetViewDoc(int id)
        {
            ...
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka3265_UPR_PU.id = list.id;
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka3265_UPR_PU.IL = list.IL;
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka3265_UPR_PU.Protokol = JsonDeserializeObject<Protokol>(ArrByteToString(list.Data.Protokol));
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo = JsonDeserializeObject<AdditionalInfo>(ArrByteToString(list.Data.AdditionalInfo));
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka3265_UPR_PU.DateTimeString = list.DateTimeString;
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka3265_UPR_PU.DateTimeLong = list.DateTimeLong;
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka3265_UPR_PU.BIK_ID = list.BIK_ID;
            ((DataIVKDoc)doc.Doc.DataIVK).TablePoverka3265_UPR_PU.IL_Name = ArrByteToString(list.IL_Name);
            ...
            foreach (var item in editDoc.AdditionalInfo.Where(x => x.Use).ToList())
            {
                ...
                if (item.Type == "list")
                {
                    ...
                    if (item.Key == "ARM_Poverka_Result")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo.ARM_Poverka_Result;
                ...
                else
                {
                    ...
                    if (item.Key == "Place")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo.Place;
                    else if (item.Key == "Place_SIKN")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo.Place_SIKN;
                    else if (item.Key == "Place_Factory")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo.Place_Factory;
                    else if (item.Key == "PR_Type")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo.PR_Type;
                    else if (item.Key == "PR_FactoryNumber")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo.PR_FactoryNumber;
                    else if (item.Key == "PR_LineName")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo.PR_LineName;
                    else if (item.Key == "PU_Type")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo.PU_Type;
                    else if (item.Key == "PU_FactoryNumber")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo.PU_FactoryNumber;
                    else if (item.Key == "IVK_Type")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo.IVK_Type;
                    else if (item.Key == "IVK_FactoryNumber")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo.IVK_FactoryNumber;
                    else if (item.Key == "ProtokolNum")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo.ProtokolNum;
                    else if (item.Key == "StaffData")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo.StaffData;                    
        ...
        public override bool SaveDoc(string jsonData)
        {
            ...
            TablePoverka3265_UPR_PUData row = new();
            GetViewDoc(data.DocID);

            ad = ((DataIVKDoc)Doc.Doc.DataIVK).TablePoverka3265_UPR_PU.AdditionalInfo;
    ...
    [Table("TablePoverka3265_UPR_PU")]
    public class TablePoverka3265_UPR_PUList
    {
        [Key, ForeignKey("Data")]
        ...
        public TablePoverka3265_UPR_PUData Data { get; set; }
    }

    [Table("TablePoverka3265_UPR_PU")]
    public class TablePoverka3265_UPR_PUData
    {
        [Key]
        public int id { get; set; }
    ...
    public class Doc : Root
    {
        public Doc()
        {
            ...
            ((DataIVKDoc)Doc.DataIVK).TablePoverka3265_UPR_PU = new TablePoverka3265_UPR_PU();
        }
    }
    ...
    {
        public TablePoverka3265_UPR_PU TablePoverka3265_UPR_PU { get; set; }
    }

    public class TablePoverka3265_UPR_PU
    {
        public int id { get; set; }
        public int IL { get; set; }
