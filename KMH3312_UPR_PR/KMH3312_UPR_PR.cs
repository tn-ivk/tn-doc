...
namespace TN.Doc
{
    public class KMH3312_UPR_PR : DocGeneral
    {
        public KMH3312_UPR_PR(DbContextOptions<DocGeneral> options, string path, Device device) : base(options, path, device)
        {
        ...
        private DbSet<TableKMH3312_UPR_PRList> ListDoc { get; set; }
        private DbSet<TableKMH3312_UPR_PRData> DataDoc { get; set; }
        ...
        public override List<RequestListDocs> GetList(long UTBegin, long UTEnd)
        {
            ...
            var list = (from item in ListDoc.AsNoTracking()
                        ...
                        select item).ToList<TableKMH3312_UPR_PRList>();
        ...
        public override object GetViewDoc(int id)
        {
            ...
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_UPR_PR.id = list.id;
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_UPR_PR.IL = list.IL;
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_UPR_PR.Protokol = JsonDeserializeObject<Protokol>(ArrByteToString(list.Data.Protokol));
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo = JsonDeserializeObject<AdditionalInfo>(ArrByteToString(list.Data.AdditionalInfo));
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_UPR_PR.DateTimeString = list.DateTimeString;
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_UPR_PR.DateTimeLong = list.DateTimeLong;
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_UPR_PR.BIK_ID = list.BIK_ID;
            ((DataIVKDoc)doc.Doc.DataIVK).TableKMH3312_UPR_PR.IL_Name = ArrByteToString(list.IL_Name);
            ...
            foreach (var item in editDoc.AdditionalInfo.Where(x => x.Use).ToList())
            {
                ...
                if (item.Type == "list")
                {
                    ...
                    if (item.Key == "ARM_Poverka_Result")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.ARM_Poverka_Result;
                ...
                else
                {
                    ...
                    if (item.Key == "Place_PSP")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.Place_PSP;
                    else if (item.Key == "Place_SIKN")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.Place_SIKN;
                    else if (item.Key == "Place_Factory")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.Place_Factory;
                    else if (item.Key == "UPR_Type")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.UPR_Type;
                    else if (item.Key == "UPR_FactoryNumber")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.UPR_FactoryNumber;
                    else if (item.Key == "PU_Type")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.PU_Type;
                    else if (item.Key == "PU_FactoryNumber")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.PU_FactoryNumber;
                    else if (item.Key == "PP_Type")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.PP_Type;
                    else if (item.Key == "PP_FactoryNumber")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.PP_FactoryNumber;
                    else if (item.Key == "IVK_Type")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.IVK_Type;
                    else if (item.Key == "IVK_FactoryNumber")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.IVK_FactoryNumber;
                    else if (item.Key == "Oil_Type")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.Oil_Type;
                    else if (item.Key == "ProtokolNum")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.ProtokolNum;
                    else if (item.Key == "ARM_Poverka_Result")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.ARM_Poverka_Result;
                    else if (item.Key == "StaffData")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.StaffData;
                    else if (item.Key == "ServiceStaffData")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.ServiceStaffData;
                    else if (item.Key == "DeliveryStaffData")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.DeliveryStaffData;
                    else if (item.Key == "RecievingStaffData")
                        currentValue = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo.RecievingStaffData;
        ...
        public override bool SaveDoc(string jsonData)
        {
            ...
            TableKMH3312_UPR_PRData row = new();
            GetViewDoc(data.DocID);

            ad = ((DataIVKDoc)Doc.Doc.DataIVK).TableKMH3312_UPR_PR.AdditionalInfo;
    ...
    [Table("TableKMH3312_UPR_PR")]
    public class TableKMH3312_UPR_PRList
    {
        [Key, ForeignKey("Data")]
        ...
        public TableKMH3312_UPR_PRData Data { get; set; }
    }

    [Table("TableKMH3312_UPR_PR")]
    public class TableKMH3312_UPR_PRData
    {
        [Key]
        public int id { get; set; }
    ...
    public class Doc : Root
    {
        public Doc()
        {
            ...
            ((DataIVKDoc)Doc.DataIVK).TableKMH3312_UPR_PR = new TableKMH3312_UPR_PR();
        }
    }
    ...
    {
        public TableKMH3312_UPR_PR TableKMH3312_UPR_PR { get; set; }
    }
    public class TableKMH3312_UPR_PR
    {
        public int id { get; set; }
        public int IL { get; set; }
